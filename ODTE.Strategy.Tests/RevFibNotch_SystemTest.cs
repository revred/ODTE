...
namespace ODTE.Strategy.Tests
{
    ...
    public class RevFibNotch_SystemTest
    {
        ...
        public void Mild_Loss_Single_Notch_Right()
        {
            ...
            Assert.Equal(1, adjustment.NotchMovement); // 1 notch right
            Assert.Equal(300m, _manager.CurrentRFibLimit); // $500 → $300
            Assert.Equal(3, _manager.CurrentNotchIndex);
            Assert.True(adjustment.Reason.Contains("MILD_LOSS"));
        ...
        public void Significant_Loss_Single_Notch_Right()
        {
            ...
            Assert.Equal(1, adjustment.NotchMovement);
            Assert.Equal(300m, _manager.CurrentRFibLimit);
            Assert.True(adjustment.Reason.Contains("SIGNIFICANT_LOSS"));
        ...
        public void Major_Loss_Two_Notches_Right()
        {
            ...
            Assert.Equal(2, adjustment.NotchMovement); // 2 notches right
            Assert.Equal(200m, _manager.CurrentRFibLimit); // $500 → $200
            Assert.Equal(4, _manager.CurrentNotchIndex);
            Assert.True(adjustment.Reason.Contains("MAJOR_LOSS"));
        ...
        public void Catastrophic_Loss_Three_Notches_Right()
        {
            ...
            Assert.Equal(3, adjustment.NotchMovement); // 3 notches right
            Assert.Equal(100m, _manager.CurrentRFibLimit); // $500 → $100 (maximum safety)
            Assert.Equal(5, _manager.CurrentNotchIndex);
            Assert.True(adjustment.Reason.Contains("CATASTROPHIC_LOSS"));
        ...
        public void Single_Profit_Day_No_Movement()
        {
            ...
            Assert.Equal(0, adjustment.NotchMovement); // No movement
            Assert.Equal(500m, _manager.CurrentRFibLimit); // Remains at $500
            Assert.True(adjustment.Reason.Contains("PROFIT_INSUFFICIENT"));
        ...
        public void Two_Consecutive_Profit_Days_One_Notch_Left()
        {
            ...
            Assert.True(adj2.Reason.Contains("SUSTAINED_PROFIT"));
        ...
        public void Major_Profit_Immediate_Upgrade()
        {
            ...
            Assert.Equal(-1, adjustment.NotchMovement); // 1 notch left immediately
            Assert.Equal(800m, _manager.CurrentRFibLimit); // $500 → $800
            Assert.True(adjustment.Reason.Contains("MAJOR_PROFIT"));
        ...
        public void Loss_Interrupts_Profit_Sequence()
        {
            ...
            Assert.Equal(1, adjustment.NotchMovement); // Move right due to loss
            Assert.Equal(300m, _manager.CurrentRFibLimit);
            Assert.Equal(0, _manager.ConsecutiveProfitDays); // Reset consecutive count
        ...
        public void Boundary_Conditions_Maximum_Safety()
        {
            ...
            Assert.Equal(0, adjustment.NotchMovement); // Cannot move further right
            Assert.Equal(100m, _manager.CurrentRFibLimit); // Remains at $100
            Assert.Equal(5, _manager.CurrentNotchIndex);
        ...
        public void Boundary_Conditions_Maximum_Aggression()
        {
            ...
            Assert.Equal(0, adjustment.NotchMovement); // Cannot move further left
            Assert.Equal(1250m, _manager.CurrentRFibLimit); // Remains at $1250
            Assert.Equal(0, _manager.CurrentNotchIndex);
        ...
        public void Status_Reporting_Accuracy()
        {
            ...
            Assert.Equal(0, status.ConsecutiveProfitDays); // Reset by loss
            Assert.Equal(6, status.AllLimits.Length);
            Assert.True(status.RecentHistory.Count > 0);
        ...
        public void Configuration_Customization()
        {
            ...
            Assert.Equal(800m, customManager.CurrentRFibLimit);
