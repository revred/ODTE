...
namespace ODTE.Strategy.Tests
{
    ...
    public class UltraOptimizedPnLAnalyzer
    {
        ...
        private void RunCurrentSystemSimulation()
        {
            ...
            {
                var monthlyPnL = monthData.HasRealData ? monthData.ActualPnL.Value : monthData.ProjectedPnL;
                var winRate = monthData.HasRealData ? monthData.ActualWinRate.Value : monthData.ProjectedWinRate;
        ...
        private decimal GenerateProjectedPnL(DateTime date, decimal vix, string regime)
        {
            ...
            {
                "CRISIS" => -200m + (decimal)(random.NextDouble() * 300m),
                "VOLATILE" => -100m + (decimal)(random.NextDouble() * 400m),
                "BULL" => 50m + (decimal)(random.NextDouble() * 300m),
                _ => -50m + (decimal)(random.NextDouble() * 300m)
            };
