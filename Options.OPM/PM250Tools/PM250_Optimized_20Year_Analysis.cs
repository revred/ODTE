...
namespace ODTE.OptimizedAnalysis
{
    ...
    {
        private const string DATABASE_PATH = @"C:\code\ODTE\Data\historical_options_data.db";
    ...
    public class OptimizedPerformanceAnalyzer
    {
        ...
        private SimulationResults RunSimulation(IRevFibNotchManager manager, string systemName)
        {
            ...
            foreach (var monthData in _historicalData)
            {
                ...
                var monthlyPnL = monthData.HasRealData ? monthData.ActualPnL : monthData.ExpectedPnL;
                var winRate = monthData.HasRealData ? monthData.ActualWinRate : monthData.BaseWinRate;
                ...
                var adjustment = manager.ProcessMonth(scaledPnL, monthData.Date, winRate);
